                    ...
                    <div>
                        ...
                        <div class="table-container">
                            <b-table
                                ...
                                <b-table-column field="fee_balance" label="Balance" v-slot="props">
                                    {{props.row.fee_balance}}
                                </b-table-column>
...
export default {
    ...
    methods: {
        loadAsyncData() {
            ...
            this.loading = true;
            axios.get(`/get-browse-billings?${params}`).then(({data}) => {
                this.data = [];
        ...
        selectData(dataRow){
            ...
            this.$emit('browseBilling', dataRow);
        },
